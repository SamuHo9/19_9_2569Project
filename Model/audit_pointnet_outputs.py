"""Audit leakage-free PointNet runs."""
...
from leakage_free_pointnet_training import POINTNET_PROTOCOL


EXPECTED = {
    (cohort, side, 'PointNet')
...
def main():
    ...
    for row in summary.itertuples():
        ...
        assert manifest['protocol'] == POINTNET_PROTOCOL
